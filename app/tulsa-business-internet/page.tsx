  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 text-center">
        ...
        <Link href="/#questionnaire" className="bg-blue-600 text-white font-bold px-10 py-4 rounded-xl hover:bg-blue-700 transition text-lg inline-block">Check Availability in Tulsa →</Link>
      </section>
