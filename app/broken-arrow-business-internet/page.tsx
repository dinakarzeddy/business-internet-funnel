...
export const metadata = {
  title: 'Business Internet Providers Broken Arrow OK | PrimeConnect',
  description: 'Compare business internet providers in Broken Arrow Oklahoma. Get fiber, wireless, VoIP, and broadband solutions for Broken Arrow businesses. Free consultation with PrimeConnect.',
}
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        <h2 className="text-2xl font-bold text-center mb-8">Available Providers in Broken Arrow</h2>
        <div className="grid md:grid-cols-2 gap-6">
          {[
            { name: 'AT&T Fiber', speed: '300 Mbps – 5 Gbps', best: 'Best for offices needing reliable fiber' },
            { name: 'Cox Business', speed: '50 Mbps – 1 Gbps', best: 'Best for Broken Arrow businesses' },
      ...
      <section className="bg-slate-900 py-16">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl font-bold text-center mb-8">Why Broken Arrow Businesses Choose PrimeConnect</h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { title: 'Local Broken Arrow Experts', desc: 'We know the Broken Arrow market and which providers deliver the best service in your area.' },
              { title: 'Compare All Providers', desc: 'One call compares AT&T, Cox, Spectrum, and more — saving you hours of research.' },
              { title: 'Fast Installation', desc: 'Most Broken Arrow businesses get connected within 5-7 business days of signing up.' },
      ...
      <section className="max-w-3xl mx-auto px-6 py-16">
        <h2 className="text-2xl font-bold text-center mb-8">Business Internet FAQ — Broken Arrow</h2>
        <div className="flex flex-col gap-4">
          {[
            { q: 'What is the best business internet provider in Broken Arrow?', a: 'AT&T Fiber and Cox Business are the top choices for Broken Arrow businesses. PrimeConnect helps you compare all options available at your specific address.' },
            { q: 'How much does business internet cost in Broken Arrow?', a: 'Business internet in Broken Arrow typically ranges from $60 to $500+ per month. PrimeConnect offers a free consultation to find the most cost-effective solution.' },
            { q: 'Is fiber internet available for businesses in Broken Arrow?', a: 'Yes — AT&T Fiber is available across much of Broken Arrow offering speeds from 300 Mbps to 5 Gbps for businesses.' },
            { q: 'How quickly can I get business internet installed in Broken Arrow?', a: 'Most providers can install business internet in Broken Arrow within 5-10 business days.' },
          ].map((item, i) => (
